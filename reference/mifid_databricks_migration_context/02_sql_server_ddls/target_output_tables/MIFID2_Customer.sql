...
/****** Object:  Table [dbo].[MIFID2_Customer]    Script Date: 5/13/2026 1:33:00 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[MIFID2_Customer](
	[CID] [int] NOT NULL,
 ...
 CONSTRAINT [PK_test_MIFID2_Customer] PRIMARY KEY CLUSTERED 
(
	[ReportDate] ASC,
	[CID] ASC,
	[RegulationID] ASC
